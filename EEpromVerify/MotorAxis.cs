...
namespace ApsMotionControl
{
    public class MotorAxis
    {
        ...
        /// 
        public MotorAxis(int axisNo, string name, int maxSpeed, double resolution, MotorDefine.eMotorType type, AXT_MOTION_MOVE_DIR homeDir, AXT_MOTION_HOME_DETECT homeSignal)
        {
            this.axisNo = axisNo;
            this.name = name;
