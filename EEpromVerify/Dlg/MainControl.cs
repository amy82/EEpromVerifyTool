...
namespace ApsMotionControl.Dlg
{
    public partial class MainControl : UserControl
    {
        ...
        private const int ResultGridRowViewCount = 20;
        ...
        private void InitResultGrid()
        {
            ...
            dataGridView_Result.Height = ResultGridRowViewCount * ResultGridRowHeight + ResultGridRowHeight - 11;// + 2;
             ...
             public enum CommunicationState
    {
        ...
        private void dataGridView_Result_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                // 첫 번째 선택된 셀을 가져오기
                DataGridViewCell selectedCell = dataGridView_Result.SelectedCells[0];
