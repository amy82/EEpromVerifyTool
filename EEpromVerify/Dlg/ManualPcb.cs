...
{
    public partial class ManualPcb : UserControl
    {
        ...
        private void BTN_MANUAL_LOAD_POS_XY_Click(object sender, EventArgs e)
        {
            ...
            bool bRtn = Globalo.motorControl.Pcb_Motor_XYT_Move(MovePos, dOffsetPos);
            if (bRtn)
            {
                MoveMotorCount = 3;
        ...
        private void BTN_MANUAL_WAIT_POS_Z_Click_1(object sender, EventArgs e)
        {
            ...
            bool bRtn = Globalo.motorControl.Motor_Axis_Move(MotorControl.eUnit.PCB_UNIT, MotorControl.ePcbMotor.PCB_Z, MovePos, dOffsetPos);
