...
namespace ApsMotionControl.Dlg
{
    public partial class IoControl : UserControl
    {
        ...
        public void InGridDraw()
        {
            ...
            InGridContentChange(Globalo.dIoControl.dCurReadModuleCh);
            for (i = 0; i < 3; i++)
            {
        ...
        public void OutGridDraw()
        {
            ...
            OutGridContentChange(Globalo.dIoControl.dCurOutModuleCh);
        ...
        public void update(object sender , System.EventArgs e)
        {
            ...
            if (upIn != m_dwPrevDIn[Globalo.dIoControl.dCurReadModuleCh])
            {
                m_dwPrevDIn[Globalo.dIoControl.dCurReadModuleCh] = upIn;
        ...
        {
            if (Globalo.dIoControl.dCurReadModuleCh > 0)
            {
                Globalo.dIoControl.dCurReadModuleCh--;
            }
        ...
        {
            if (Globalo.dIoControl.dCurOutModuleCh > 0)
            {
                Globalo.dIoControl.dCurOutModuleCh--;
            }
