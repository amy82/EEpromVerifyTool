...
namespace ApsMotionControl
{
    public class CLaonGrabberClass : IDisposable
    {
        ...
        public void UiconfigLoad()
        {
            ...
            string mFilePath = Data.CPath.MIU_DIR + "\\UIConfig\\UIConfig.ini"; // "Initialize\\M3_TESLA_DES964_M3.ini";
            string mGetFilename = "";
            string miniFilePath = "";
            StringBuilder sb = new StringBuilder(255);
            GetPrivateProfileString("UIConfig", "GrabberINI", "Default.ini", sb, Globalo.MAX_PATH, mFilePath);
            mGetFilename = sb.ToString();
            miniFilePath = Data.CPath.MIU_DIR + "\\" + mGetFilename;
        ...
        public void SelectSensor()
        {
            ...
            eLogSender("GrabberDll", $"Width:" + m_nWidth.ToString());
            eLogSender("GrabberDll", $"Height:" + m_nHeight.ToString());
